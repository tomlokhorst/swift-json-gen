...
function structs(ast, aliases) {
    ...
    var structs = sts.flatMap(function (a) { return struct(a, aliases); });
    return structs;
}
...
function enums(ast, aliases) {
    ...
    return enums.flatMap(function (a) { return enum_(a, aliases); });
}
exports.enums = enums;
function enum_(ast, aliases, prefix) {
    ...
    var rs = ast.children('enum_decl').flatMap(function (a) { return enum_(a, aliases, baseName); });
    return [r].concat(rs);
}
