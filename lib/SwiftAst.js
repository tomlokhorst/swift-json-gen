...
function struct(ast, aliases, prefix) {
    ...
    var constructorDecls = ast.children('constructor_decl')
        .filter(function (a) { return a.attr('access') != 'private'; });
    var constructorsParams = constructorDecls.map(function (constructorDecl) {
        var constructorParams = constructorDecl
