...
function generate() {
    ...
    var xcode = typeof (argv.xcode) == 'string' ? argv.xcode : null;
    ...
    function afterStatham(stathamTempDir) {
        if (typeof (outputDirectory) == 'string') {
            mkdirp(outputDirectory, function (err) { return handleFiles(inputs, accessLevel, stathamTempDir, outputDirectory); });
        }
        else {
